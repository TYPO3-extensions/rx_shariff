# -*- coding: utf-8 -*-
#
# Heise Shariff Backend Module documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 25 Feb 2015 20:11:47 +0000.
#
...
project = u'Heise Shariff Backend Module'
copyright = u'2015, Markus Klein'
...
htmlhelp_basename = 'rx_shariffdoc'
...
latex_documents = [
    ('Index', 'rx_shariff.tex', u'Heise Shariff Backend Module',
     u'Markus Klein', 'manual'),
]
...
pdf_documents = [
    ('Index', 'rx_shariff', u'Heise Shariff Backend Module',
     u'Markus Klein'),
]
...
texinfo_documents = [
    ('Index', 'rx_shariff', u'Heise Shariff Backend Module',
     u'Markus Klein', 'Heise Shariff Backend Module', 'One line description of project.',
     'Miscellaneous'),
]
